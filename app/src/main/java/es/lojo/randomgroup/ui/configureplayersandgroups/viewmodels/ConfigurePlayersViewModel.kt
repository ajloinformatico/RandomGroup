...
import es.lojo.randomgroup.ui.configureplayersandgroups.states.ConfigurePlayersErrors
...
class ConfigurePlayersViewModel : ViewModel() {
    ...
    private fun getConfigurationsPlayer(): ConfigureOfPlayersModel =
        ConfigureOfPlayersModel(
            competitionName = _competitionName.value.orEmpty().takeIf { it.isNotEmpty() }
                ?: RANDOM_CHAMPIONS,
